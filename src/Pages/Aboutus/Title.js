    ...
    return (
        <div className='relative z-0 '>
            ...
            <div className='top-[22vmin]  text-[#fff] w-1/3 absolute  right-[2vmin] md:right-[10vmin] lg:right-[25vmin] flex flex-col justify-center items-center'>
                <h1 className='sm:text-lg md:text-xl lg:text-6xl text-right tracking-widest leading-[1.3em]'>ABOUT US</h1>
            </div>
            ...
            <img className='w-[100vw]  h-[60vh] left-0 top-0 z-10 bg-repeat' src={img.Aboutus} alt=""></img>
        </div>
    )
}
